...
public class CubeTest {
	...
	public void testToScad1() {
		...
		assertEqualsWithoutWhiteSpaces("cube([10,10,10],center=true);", cube.toScad(ScadGenerationContext.DEFAULT));
	}
	
	@Test
	public void testToScad2() {
		Cube cube = new Cube(new Dims3d(10.0, 20.0, 30.0));
		assertEqualsWithoutWhiteSpaces("cube([10,20,30],center=true);", cube.toScad(ScadGenerationContext.DEFAULT));
	}
	
	@Test
	public void toScadShouldBeRounded() {
		Cube cube = new Cube(new Dims3d(Math.PI, 20.0, 30.0));
		assertEqualsWithoutWhiteSpaces("cube([3.1416,20,30],center=true);", cube.toScad(ScadGenerationContext.DEFAULT));
	}
