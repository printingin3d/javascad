...
public class Abstract3dModelTest {
	...
	public void testDefault() {
		assertEqualsWithoutWhiteSpaces("(empty)", testSubject.toScad());
	}
	...
	public void testMove() {
		...
		assertEqualsWithoutWhiteSpaces("translate([10,20,30])(empty)", testSubject.toScad());
	}

	@Test
	public void testMoves() {
		testSubject.moves(Arrays.asList(new Coords3d(10.0, 20.0, 30.0), new Coords3d(30.0, 10.0, 20.0)));
		assertEqualsWithoutWhiteSpaces("union(){translate([10,20,30])(empty)translate([30,10,20])(empty)}", testSubject.toScad());
	}
	...
	public void testRotate() {
		...
		assertEqualsWithoutWhiteSpaces("rotate([10,20,30]) (empty)", testSubject.toScad());
	}
	...
	public void testMoveAndRotate() {
		...
		assertEqualsWithoutWhiteSpaces("translate([30,10,20]) rotate([10,20,30]) (empty)", testSubject.toScad());
	}
	...
	public void testRotateAndMove() {
		...
		assertEqualsWithoutWhiteSpaces("translate([0,0,30]) rotate([90,0,0]) (empty)", testSubject.toScad());
	}
	...
	public void testMoveRotateAndMove() {
		...
		testSubject.rotate(Angles3d.ROTATE_PLUS_X);
		testSubject.move(new Coords3d(30.0, 10.0, 20.0));
		assertEqualsWithoutWhiteSpaces("translate([30,10,50]) rotate([90,0,0]) (empty)", testSubject.toScad());
	}
	...
	public void testMovesAndRotate() {
		testSubject.rotate(new Angles3d(10.0, 20.0, 30.0));
		testSubject.moves(Arrays.asList(new Coords3d(10.0, 20.0, 30.0), new Coords3d(30.0, 10.0, 20.0)));
		assertEqualsWithoutWhiteSpaces("union(){translate([10,20,30]) rotate([10,20,30]) (empty) translate([30,10,20]) rotate([10,20,30]) (empty)}", testSubject.toScad());
	}
	...
	public void testAlignTop() {
		...
		assertEqualsWithoutWhiteSpaces("translate([0, 0, 25]) (empty)", testSubject.toScad());
	}
	...
	public void testAlignBottom() {
		...
		assertEqualsWithoutWhiteSpaces("translate([0, 0, -30]) (empty)", testSubject.toScad());
	}
	...
	public void testAlignRight() {
		...
		assertEqualsWithoutWhiteSpaces("translate([25, 0, 0]) (empty)", testSubject.toScad());
	}
	...
	public void testAlignLeft() {
		...
		assertEqualsWithoutWhiteSpaces("translate([-30, 0, 0]) (empty)", testSubject.toScad());
	}
	...
	public void testAlignBack() {
		...
		assertEqualsWithoutWhiteSpaces("translate([0, 25, 0]) (empty)", testSubject.toScad());
	}
	...
	public void testAlignFront() {
		...
		assertEqualsWithoutWhiteSpaces("translate([0, -30, 0]) (empty)", testSubject.toScad());
	}
}
