...
public class BoundedModelTest {
	...
	public void testInnerToScad() {
		...
		Assert.assertEquals(baseModel.toScad(ScadGenerationContext.DEFAULT), testSubject.toScad(ScadGenerationContext.DEFAULT));
	}
	...
	public void testMove() {
		...
		BoundedModel testSubject = new BoundedModel(baseModel, null);
		assertEqualsWithoutWhiteSpaces("translate([10,20,30])(model)", testSubject.toScad(ScadGenerationContext.DEFAULT));
	}

	@Test
	public void testWithNullModel() {
		BoundedModel testSubject = new BoundedModel(null, null);
		assertEqualsWithoutWhiteSpaces("", testSubject.toScad(ScadGenerationContext.DEFAULT));
	}
}
