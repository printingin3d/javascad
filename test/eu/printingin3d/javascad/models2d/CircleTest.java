...
public class CircleTest {
	...
	public void testToScad() {
		...
		assertEqualsWithoutWhiteSpaces("circle(r=5.5,center=true);", circle.toScad(ScadGenerationContextFactory.DEFAULT).getScad());
	}
	
	@Test
	public void toScadShouldBeRounded() {
		Circle circle = new Circle(Math.PI);
		assertEqualsWithoutWhiteSpaces("circle(r=3.1416,center=true);", circle.toScad(ScadGenerationContextFactory.DEFAULT).getScad());
	}
